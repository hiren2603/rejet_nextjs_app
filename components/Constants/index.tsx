...
export const SIDE_BAR_ARRAY : SIDE_BAR_ARRAY_TYPE = [
    ...
    { key : "Products", icon : <ProductSvg/>, id : 3, multicomponent : true, multicomponents : [
        { key : "Inkjet", id : 7, nestedcomponent : false, innercomponent : []},
        { key : "Laser", id : 8, nestedcomponent : true, innercomponent : [
            { key : "CO2 Laser", id : 9},
            { key : "Fiber Laser", id : 10},
            { key : "UV Laser", id : 11},
            { key : "Desktop Laser", id : 12}
        ]},
        {key : "Thermal", id : 13, nestedcomponent : false, innercomponent : []}
    ] },
